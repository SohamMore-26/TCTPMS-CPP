...
<head>
    ...
    <title>Teacher Home Module</title>
</head>
        ...
        <div class="main_c_cont">
            ...
            if (isset($_SESSION['teacherId'])) {
                ...
                foreach ($timeSlots as $timeSlot) {
                    ...
                    ${'view_' . $timeSlot['slot'][0]} = mysqli_query($con, $query) or die(mysqli_error($con));
                }

                // Printing timetable
                echo '<div class="t_tb_card t_tablecss">
                ...
                foreach ($timeSlots as $timeSlot) {
                    ...
                    for ($i = 1; $i <= 6; $i++) {
                        ...
                        $view = ${'view_' . $timeSlot['slot'][0]}; // Get the respective view
                ...
                echo "Session error. Please try logging in again.";
            }
            ?>
        </div>
    </div>
