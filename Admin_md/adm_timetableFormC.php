                            ...
                            <div class="formdiv">
                                <div class="input">
                                    ...
                                    <div style=" display:flex ">
                                        ...
                                        <input type="radio" id="Pr" name="ThPr" onclick="openDialog(this)"
                                            value="Practical">Pr
    
                                        <input type="radio" id="Tu" name="ThPr" onclick="openDialog(this)"
                                            value="Tutorial">Tu
                                    </div>
                                </div>
                                ...
                                <div class="thr thr_hid" id="thr">
                                    <?php
                                    include "config.php";
                                    $queryResult = mysqli_query($con, "select courseAbrevation from courseinfo ") or die(mysqli_error($con));
                                    ...
                                    <div class="input">
                                        ...
                                        <select id="sub" name="time_course" class="sem">
                                            ...
                                            <?php foreach ($rows as $row): ?>
                                                <option value="<?= $row['courseAbrevation'] ?>">
                                                    <?= $row['courseAbrevation'] ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="pra pra_hid" id="pra">
                                    <div class="input">
                                        <b><label for="batch1" class="label">batch1 :</label></b>
                                        <select class="sem" id="batch1" name="batch1">
                                    ...
                                    <div class="input">
                                        <b><label for="batch2" class="label">batch2 :</label></b>
                                        <select class="sem" id="batch2" name="batch2">
                                            <option value="">Select Course</option>
                                            <?php foreach ($rows as $row): ?>
                                                <option value="<?= $row['courseAbrevation'] ?>">
                                                    <?= $row['courseAbrevation'] ?>
                                    ...
                                    <div class="input">
                                        <b><label for="batch3" class="label">batch3 :</label></b>
                                        <select class="sem" id="batch3" name="batch3">
                                            <option value="">Select Course</option>
                                            <?php foreach ($rows as $row): ?>
                                                <option value="<?= $row['courseAbrevation'] ?>">
                                                    <?= $row['courseAbrevation'] ?>
